...
type Props = React.ComponentProps<'input'> & { label?: string; error?: string }

/** Non contrôlé (pas de `value` forcé). */
export function PlainInput({ className, type = 'text', label, error, ...rest }: Props) {
  return (
    <div className="space-y-1">
      ...
      <input
        ...
        {...rest} /* defaultValue, placeholder, etc. */
      />
